...
//                    sb.append(outer.get(i).getName()).append("[").append(i).append("]");
...
//            if (c == '{') {
//                Nod inner = new Nod();
//                PositionHolder pos = getText(i + 1, s, inner);
//                i = pos.getIndex();
//                inner.setName(pos.getText());
//                PositionHolder value = getValue(i + 1, s, inner);
//                i = value.getIndex()-1;
//                inner.setValue(value.getText());
//                inner.setParent(nod);
...
//
//            if (c == '{') {
//                PositionHolder pos  = buildTree(i, s, nod);
//                return pos;
//            } else if (c == ',' || c == '}') {
...
//
//
//    public PositionHolder getText(int k, String s, Nod nod) {
//
//        boolean f = false;
//        StringBuilder sb = new StringBuilder();
//        for (int i = k; i < s.length(); i++) {
